package com.example.projectlocator.Util.Realm;//package Util.Realm;
...
public class RealmController {
    ...
    public RealmResults<UserLocation> getUserLocations() {

        return realm.where(UserLocation.class).findAll();
    }

    //query a single item with the given id
    public UserLocation getUserLocations(String id) {
